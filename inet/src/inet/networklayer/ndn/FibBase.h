...
public:
    ...
    /* */
    virtual FibEntry* lookup(NdnPacket* packet) override;

    /* */
    virtual bool registerPrefix(const char* prefix, cGate* face, MACAddress dest) override;

    /* */
    virtual bool create(const char* prefix, short length, cGate* face, MACAddress dest) override;
...
private:
    std::vector<IFib::FibEntry *> entries;
