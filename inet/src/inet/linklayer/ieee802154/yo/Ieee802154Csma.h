...
#ifndef __INET_IEEE802154CSMA_H
#define __INET_IEEE802154CSMA_H
...
#define NORMAL_MEAN 0.5  // (A_MAX / 2) ~ 2.5
#define NORMAL_SD 0.5    // P(X <= A_MIN) ~ 0
...
/**
 * @brief Ieee802.15.4 CSMA Mac-Layer.
 *
 * @author Amar Abane
 *
 */
class INET_API Ieee802154Csma : public MACProtocolBase, public IMACProtocol
{
  public:
    Ieee802154Csma()
        : MACProtocolBase()
...
//  cObject* setDownControlInfo(cMessage * const pMsg, Signal * const pSignal);
  ...
  private:
     ...
     */
    Ieee802154Csma(const Ieee802154Csma&);
    /** @brief Assignment operator is not allowed.
     */
    Ieee802154Csma& operator=(const Ieee802154Csma&);
};

} // namespace inet

#endif // ifndef __INET_IEEE802154CSMA_H
